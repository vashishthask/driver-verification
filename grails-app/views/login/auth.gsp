				...
				<div class="sign-in">
					...
					<table>
						<tr>
							...
							<td><input name="j_username" id="username" size="38" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><img
								...
								<label for="captcha">Type the letters above in the box
									below:</label> <g:textField name="captcha" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td><s2ui:submitButton elementId='loginButton'
									form='loginForm' messageCode='spring.security.ui.login.login' /></td>
							<td><s2ui:linkButton elementId='register'
									controller='register'
