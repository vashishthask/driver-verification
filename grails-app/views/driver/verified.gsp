...
<html>
	...
	<body>
		...
		<div id="list-driver" class="content scaffold-list" role="main">
			<h1><g:message code="default.list.verified.label" args="[entityName]" /></h1>
			...
			<div class="pagination">
				<g:paginate total="${driverInstanceCount == null ? Driver.count(): driverInstanceCount}" params="${filterParams}" />
		...
		<filterpane:filterPane domain="com.amigo.verifydriver.Driver" 
			...
			additionalProperties="id" action="filterVerified"/>	</body>
</html>
