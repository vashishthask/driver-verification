...
<html>
	...
	<body>
		...
		<div id="edit-driver" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:driverInstance, action:'update']" method="PUT"  enctype="multipart/form-data">
				<g:hiddenField name="version" value="${driverInstance?.version}" />
				<g:hiddenField name="driverDetailsFromCitizenId" value="${driverDetailsFromCitizenId}" />
				<fieldset class="form">
