...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.amigo.verifydriver.security.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.amigo.verifydriver.security.UserRole'
grails.plugin.springsecurity.authority.className = 'com.amigo.verifydriver.security.Role'
...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
	...
	'/driver/search':                 ['permitAll'],
	'/driverDetailsFromCitizen/**':   ['permitAll'],
