...
import com.amigo.verifydriver.Constants
...
public class UsernamePasswordAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
	...
	private String captchaParameter = Constants.CAPTCHA;
    ...
    public UsernamePasswordAuthenticationFilter() {
		...
		simpleCaptchaService = (SimpleCaptchaService) ctx.getBean("simpleCaptchaService");
    }
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
		...
		println "the captcha is:${captcha}"
		...
		println "the captcha is:${captchaValid}"
		if(!captchaValid){
			throw new BadCredentialsException(messages.getMessage(
                            "AbstractUserDetailsAuthenticationProvider.badCredentials", "Captcha is invalid"));
		}
